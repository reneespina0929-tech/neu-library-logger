          ...
          <div style={{
            ...
            {!showReset ? (
              <>
                ...
                <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 13, marginBottom: 24 }}>Use your NEU Google account to continue</p>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  ...
                  }} style={{ width: "100%", padding: "13px", background: "white", color: "#3c4043", fontWeight: 700, fontSize: 15, borderRadius: 10, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, border: "none", boxShadow: "0 2px 8px rgba(0,0,0,0.15)", fontFamily: "'Poppins',sans-serif" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <span style={{ color: "rgba(255,255,255,0.25)", fontSize: 11 }}>Staff / Admin login</span>
                    <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.08)" }} />
                  </div>
                  ...
                  <div>
                    ...
                    <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@neu.edu.ph" style={inputStyle}
                      onFocus={e => e.target.style.borderColor = "var(--gold)"} onBlur={e => e.target.style.borderColor = "rgba(255,255,255,0.2)"} />
                  </div>
                  <div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                      <label style={labelStyle}>Password</label>
                      <button onClick={() => { setShowReset(true); setResetEmail(email); setResetSent(false); }}
                  ...
                  <button onClick={handleSubmit} disabled={loading} style={{ width: "100%", padding: "11px", background: loading ? "rgba(13,31,60,0.5)" : "var(--navy)", color: "white", fontWeight: 700, fontSize: 14, borderRadius: 8, cursor: loading ? "not-allowed" : "pointer", border: "1px solid rgba(255,255,255,0.15)", fontFamily: "'Poppins',sans-serif" }}>
